...
def menu(my_name,my_id):
	...
	cetak(panel(f"[bold white][[bold cyan]01[bold white]] Crack Publick [[bold green] ON [bold white]]                  [bold white][[bold cyan]06[bold white]] Crack Username [[bold green] ON [bold white]]\n[bold white][[bold cyan]02[bold white]] Crack Massal [[bold green] ON [bold white]]                   [bold white][[bold cyan]07[bold white]] Crack Email [[bold green] ON [bold white]]                   [bold white][[bold cyan]03[bold white]] Crack Followers [[bold green] ON [bold white]]                [bold white][[bold cyan]08[bold white]] Crack Nomor [[bold green] ON [bold white]]\n[bold white][[bold cyan]04[bold white]] Crack File [[bold green] ON [bold white]]                     [bold white][[bold cyan]09[bold white]] Cek Result [bold white][[bold green] ON [bold white]]                [bold white][[bold cyan]05[bold white]] Crack Grup [[bold green] ON [bold white]]                     [bold white][[bold cyan]00[bold white]] [bold red]Hapus Cookie [bold white][[bold green] ON [bold white]]",width=90,title=f"[bold green]List Menu",padding=(0,8),style=f"bold white"))
